...
// Lấy tháng và năm từ GET request, nếu không có thì mặc định là tháng và năm hiện tại
$month = isset($_GET['month']) ? (int)$_GET['month'] : date('n'); // Mặc định là tháng hiện tại
$year = isset($_GET['year']) ? (int)$_GET['year'] : date('Y'); // Mặc định là năm hiện tại
